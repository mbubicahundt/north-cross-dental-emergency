...
const treatments = [
  "Children's emergency tooth pain relief",
  "Broken or chipped tooth repair",
  "Knocked-out tooth treatment",
  "Pediatric tooth extractions",
  "Children's dental infection treatment",
  "Crown or filling replacement for kids",
];

const ChildServicesSection = () => (
  <section className="bg-muted px-4 py-12">
    <div className="mx-auto max-w-xl">
      <h2 className="mb-6 text-2xl font-bold text-foreground md:text-3xl">
        Children's Emergency Dental Treatments We Provide
      </h2>
...
export default ChildServicesSection;
