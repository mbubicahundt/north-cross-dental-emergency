...
import heroImage from "@/assets/hero-dentists.webp";
  ...
  <section className="bg-background px-4 pb-12 pt-8">
    <div className="mx-auto max-w-xl">
      ...
      <h1 className="mb-4 text-3xl font-bold leading-tight text-foreground md:text-4xl">
        Emergency Dentist In Huntersville — Same Day Appointments
      </h1>
      <p className="mb-6 text-lg text-muted-foreground">
        Severe tooth pain? Broken tooth? Dental infection?<br />
        Our emergency dental team is ready to help today.
      </p>

      <img src={heroImage} alt="Dr. Bryan Persinger, DDS and Dr. Connor Zehak, DMD at North Cross Dental Care"
      ...
      <div className="grid grid-cols-2 gap-3">
        {[
          ...
          { icon: Users, label: "Experienced Dental Team" },
