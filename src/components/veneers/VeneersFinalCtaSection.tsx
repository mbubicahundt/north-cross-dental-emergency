...
const VeneersFinalCtaSection = () => (
  <section className="bg-promo px-4 py-16">
    <div className="mx-auto max-w-xl md:max-w-4xl text-center">
      ...
      <p className="mb-6 text-lg text-promo-foreground/90">
        Porcelain veneers can transform your smile in just two visits. Call now to schedule your consultation.
      </p>
...
export default VeneersFinalCtaSection;
