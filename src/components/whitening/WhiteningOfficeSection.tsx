  ...
  <section className="bg-muted px-4 py-12">
    <div className="mx-auto max-w-xl md:max-w-4xl">
      ...
      <p className="mb-6 text-muted-foreground">
        Relax in a comfortable, state-of-the-art environment designed with your experience in mind.
      </p>
...
export default WhiteningOfficeSection;
