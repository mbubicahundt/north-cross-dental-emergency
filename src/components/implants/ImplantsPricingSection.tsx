...
const benefits = [
  "15% off dental implants — non-financed treatments*",
...
const ImplantsPricingSection = () => (
  <section className="bg-background px-4 py-12">
    <div className="mx-auto max-w-xl md:max-w-4xl">
      <h2 className="mb-6 text-2xl font-bold text-foreground md:text-3xl">
        A Permanent Smile At A Better Price
      </h2>
      ...
      <div className="mb-6 rounded-xl border border-border bg-muted/50 p-4">
        ...
        <p className="text-sm text-muted-foreground">
          Apply for CareCredit or Cherry Financing right in our office. We'll also work with your insurance to maximize your benefits so you pay as little out of pocket as possible.
        </p>
      </div>
      ...
      <p className="mt-4 text-center text-[10px] text-muted-foreground">
        *15% discount applies to non-financed treatments paid in full at time of service. Cannot be combined with other offers.
      </p>
    </div>
  </section>
);

export default ImplantsPricingSection;
