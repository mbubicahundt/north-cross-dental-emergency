...
const benefits = [
  "15% off your Invisalign case — limited time",
...
const InvisalignPricingSection = () => (
  <section className="bg-background px-4 py-12">
    <div className="mx-auto max-w-xl md:max-w-4xl">
      <h2 className="mb-6 text-2xl font-bold text-foreground md:text-3xl">
        Straighter Teeth At A Better Price
      </h2>
      ...
      <div className="mb-6 rounded-xl border border-border bg-muted/50 p-4">
        ...
        <p className="text-sm text-muted-foreground">
          Apply for CareCredit or Cherry Financing right in our office. Many patients pay as little as $99/month. We'll also work with your insurance to maximize your benefits.
        </p>
      </div>
...
export default InvisalignPricingSection;
