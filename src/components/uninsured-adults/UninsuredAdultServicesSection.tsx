...
const UninsuredAdultServicesSection = () => (
  <section className="bg-muted px-4 py-12">
    <div className="mx-auto max-w-xl md:max-w-4xl">
      <h2 className="mb-6 text-2xl font-bold text-foreground md:text-3xl">
        Affordable Adult Dental Services
      </h2>

      <div className="mb-6 grid gap-6 md:grid-cols-2">
        <img src={heroImage} alt="Dentist consulting with an adult patient"
...
export default UninsuredAdultServicesSection;
