...
import heroImage from "@/assets/uninsured-adult-hero.webp";
import logo from "@/assets/NCDC_Trans.webp";

const UninsuredAdultHeroSection = () => (
  <section className="bg-background px-4 pb-12 pt-8">
    <div className="mx-auto max-w-xl md:max-w-4xl">
      ...
      <div className="md:flex md:items-start md:gap-8">
        <div className="md:flex-1">
          <h1 className="mb-4 text-3xl font-bold leading-tight text-foreground md:text-4xl">
            Affordable Dentist In Huntersville — No Insurance Needed
          </h1>
          <p className="mb-6 text-lg text-muted-foreground">
            Don't let a lack of dental insurance keep you from the care you deserve. We offer many flexible options to fit every budget.
          </p>

          <ul className="mb-6 space-y-2 text-foreground">
            {[
              "Multiple affordable treatment options",
        ...
        <img src={heroImage} alt="Friendly dentist consulting with a relaxed adult patient in a modern dental office"
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
        {[
          { icon: DollarSign, label: "Affordable Options" },
...
export default UninsuredAdultHeroSection;
